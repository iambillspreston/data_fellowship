...
```{r}
setwd("C:/Users/Decoded/Downloads")
...
plot(decompose(series_volume, type = "multiplicative"), ylab= "usd_volume")

plot(decompose(series_volume), ylab = "price in USD")
...
boxplot(usd_volume_ts~cycle(usd_volume_ts),     names=c("Jan","Feb","Mar","Apr","May","June","July","Aug","Sep","Oct","Nov","Dec"), ylab= "Volume Traded in USD", xlab="Month")
...
# The graph appears to indicate that the mean of the result could be closer to 0.

# Next the stationarity of this series is tested using the kpss test.  If the non-stationarity has been removed, then the p-value will be 0.05 or smaller.
...
# None of the terms appear to reduce below the significance threshold.
...
# The auto correlation function cuts off after the 4th term.
...
#model_volume <- auto.arima(usd_volume_ts)

model_volume <- Arima(usd_volume_ts/1000, order=c(1,0,4))

plot((model_volume$x), col = "red")
lines((model_volume$fitted), col = "blue")
